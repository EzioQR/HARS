...
import p_heu.search.SingleExecutionSearch2;

import java.io.IOException;
import java.util.ArrayList;
import java.util.Set;

public class SequenceProduceListener2 extends ListenerAdapter {
    ...
    public SequenceProduceListener2(Set<Sequence> correctSeqs) {
    ...
    private void initCurrentState(VM vm,Search search) {
        SingleExecutionSearch2 dbsearch = (SingleExecutionSearch2) search;
        //从search中，获取正确的序列
