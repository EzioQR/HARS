...
import p_heu.search.CoverageBasedSearch;

import java.util.ArrayList;
import java.util.Set;

public class BasicPatternFindingListener2 extends ListenerAdapter {
    ...
    public BasicPatternFindingListener2(Set<Sequence> correctSeqs,String filepath) {
    ...
    private void initCurrentState(VM vm,Search search) {
        CoverageBasedSearch dbsearch = (CoverageBasedSearch) search;
        //从search中，获取正确的序列
    ...
    public void searchFinished(Search search) {
        ...
        //VM vm = search.getVM();
        //initCurrentState(vm,search);
        errorSequence = ((CoverageBasedSearch) search).getErrorSequence();
